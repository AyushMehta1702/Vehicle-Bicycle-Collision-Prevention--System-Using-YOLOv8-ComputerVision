...
#
#             cv2.rectangle(swindow, (win_x_low, win_y_low), (win_x_high, win_y_high), (0, 255, 0), 2)
#
...
#         lane_inds_list.append((lane_inds, window_counts))
#
#     lane_type_list = [ ]
#
#     for lane_inds, window_counts in lane_inds_list:
#         if window_counts > 12:
#             lane_type = 'Solid'
#             print(lane_type)
#         elif window_counts in [2,3,4,5]:
#             lane_type = 'bicycle'
#             print(lane_type)
#         elif window_counts in [6,7,8,9,10,11,12]:
#             lane_type = 'vehicle'
#             print(lane_type)
#         else:
#             lane_type = 'Other'
...
#
#     return lane_inds_list, nonzerox, nonzeroy, lane_type_list, swindow
#----------------------------------------------------------------------------------------
#swindow = np.dstack((binary_warped, binary_warped, binary_warped)) * 255
