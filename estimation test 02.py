...
w = 43 #object width in pixel
d = 2000 #distance in real between object and cam
W = 175 # real width of object
...
for box in boxes:
    ...
    if cls == 0:
       ...
       # cv2.putText(image, results[0].names[3], (x1,y1-8), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 165, 0), 3)
        ...
        cv2.putText(image, label01, (x1, y1 - 8), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 165, 255), 1)
...
#cv2.imwrite(r'C:\Users\abm_0\OneDrive\Desktop\ref_img_01', image)
cv2.imwrite(r'C:\Users\abm_0\OneDrive\Desktop\RefEst_car01.jpg', image)
